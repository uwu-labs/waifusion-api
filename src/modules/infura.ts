...
const waifusContractJson = fs.readFileSync(__dirname + "/../data/abi/Waifus.json");
...
export default fp((fastify: IWaifusionInstance, _opts: FastifyPluginOptions, next: any) => {
  ...
  const waifusContract = new web3.eth.Contract(waifusContractAbi, Config.WAIFUS_CONTRACT_ADDRESS);
